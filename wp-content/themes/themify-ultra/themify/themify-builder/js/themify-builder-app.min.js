...
(!0===d?e.push(k):e[g]=k)}else if(g===f)"{}"===a[g]||""===a[g]?(delete a[g],delete e[g]):(k=a[g],"string"===typeof k&&(k=JSON.parse(k)),a[g]=e[g]=k);else if("object"===typeof a[g])++c,k=this.clear(a[g],!1,c),h.isEmptyObject(k)||(e[g]=k);else if(null!==a[g]&&a[g]!==t&&""!==a[g]&&""!==g&&"pixels"!==a[g]&&"default"!==a[g]&&"|"!==a[g]&&!("show"===a[g]&&0===g.indexOf("visibility_")||"unstick_when_condition"===g&&"hits"===a[g]||("stick_at_pos_val_unit"===g||"unstick_when_pos_val_unit"===g)&&"px"===a[g]))if("custom_parallax_scroll_speed"!==
g||a[g]&&"0"!=a[g])if("unstick_when_element"===g&&"builder_end"===a[g]||"stick_at_check"===g&&"stick_at_check"!==a[g])delete e.unstick_when_el_row_id,delete e.unstick_when_el_mod_id,delete e.unstick_when_condition,delete a.unstick_when_el_row_id,delete a.unstick_when_el_mod_id,delete a.unstick_when_condition,delete e.unstick_when_pos,delete e.unstick_when_pos_val,delete e.unstick_when_element,delete e.unstick_when_pos_val_unit,delete a.unstick_when_pos,delete a.unstick_when_pos_val,delete a.unstick_when_pos_val_unit,
delete a.unstick_when_element,"stick_at_check"===g&&(delete a[g],delete e[g],delete a.stick_at_position,delete e.stick_at_position);else if("stick_at_position"===g&&"top"===a[g]||g===b.GS.key&&""===a[g].trim()||"background_gradient-css"===g||"cover_gradient-css"===g||"cover_gradient_hover-css"===g||"background_image-type_image"===g||"custom_parallax_scroll_reverse_reverse"===g||"|single"===a[g]||"|multiple"===a[g]||("custom_parallax_scroll_reverse"===g||"custom_parallax_scroll_fade"===g||"visibility_all"===
g||"sticky_visibility"===g)&&!a[g])delete a[g],delete e[g];else{if("builder_content"===g)"string"===typeof a[g]&&(a[g]=JSON.parse(a[g])),a[g]=this.clear(a[g],!0,1);else if(1===c){var l=[];if("px"===a[g]&&-1!==g.indexOf("_unit",2))k=g.replace("_unit",""),a[k]||l.push(g);else if(0===g.indexOf("checkbox_")&&-1!==g.indexOf("_apply_all",6)){a[g]?e[g]=a[g]:l.push(g);k=g.replace("_apply_all","").replace("checkbox_","");for(var m=["top","left","right","bottom"],q=3;-1<q;--q){var p=k+"_"+m[q]+"_unit";"px"===
a[p]?l.push(p):a[p]!==t&&null!==a[p]&&""!==a[p]&&(e[p]=a[p])}}else-1!==g.indexOf("gradient",3)?("180"==a[g]||"linear"===a[g]||a[g]===h.ThemifyGradient["default"]||!1===a[g]&&-1!==g.indexOf("-circle-radial",3))&&l.push(g):("background_zoom"===g&&""===a[g]||"none"===a[g]&&-1!==g.indexOf("frame_layout")||"solid"===a[g]||!1===a[g]&&(-1!==g.indexOf("_user_role",3)||-1!==g.indexOf("_appearance",3)))&&l.push(g);if(0<l.length){for(q=l.length-1;-1<q;--q)delete e[l[q]],delete a[l[q]];l.length=0;continue}}!0===
d?e.push(a[g]):e[g]=a[g]}else delete e.custom_parallax_scroll_reverse,delete e.custom_parallax_scroll_fade,delete e[g],delete a.custom_parallax_scroll_reverse,delete a.custom_parallax_scroll_fade,delete a[g];return e},clearElementId:function(a,d){for(var c in a){!0===d?a[c].element_id=b.Utils.generateUniqueID():delete a[c].element_id;var e=a[c].styling!==t?a[c].styling:a[c].mod_settings;if(e!==t){if(e.custom_css_id!==t&&""!==e.custom_css_id)for(var f=2;;){var g=e.custom_css_id+"-"+f.toString(),h=
r.getElementById(g);if(null===h||null===h.closest(".module_row")){e.custom_css_id=g;break}++f}e.builder_content!==t&&(f="string"===typeof e.builder_content?JSON.parse(e.builder_content):e.builder_content,this.clearElementId(f,!0),e.builder_content=f)}a[c].cols!==t?this.clearElementId(a[c].cols,d):a[c].modules!==t&&this.clearElementId(a[c].modules,d)}},clearLastEmptyRow:function(a){for(var d=a.length-1;-1<d;--d){var c=a[d].attributes!==t?a[d].attributes:a[d];if(c.styling===t||null===c.styling||0===
Object.keys(c.styling).length){var c=c.cols,e=!0,f;for(f in c)if(c[f].modules!==t&&(0<c[f].modules.length||0<Object.keys(c[f].modules).length)||c[f].styling!==t&&null!==c[f].styling&&0<Object.keys(c[f].styling).length){e=!1;break}if(!0===e)a[d].cid!==t&&(b.Models.Registry.remove(a[d].cid),a[d].destroy()),a.splice(d,1);else break}else break}},builderPlupload:function(a,d){var c=d?!0:!1,e=c?[d]:n.Lightbox.$lightbox[0].getElementsByClassName("tb_plupload_upload_uic"),f=e.length;if(0<f){var g=c?!1:"new_elemn"===
